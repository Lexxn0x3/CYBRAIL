...
\usepackage{url}
\usepackage[toc,acronym]{glossaries} % Acronmyme im Glossar unterstützen
\usepackage{pdfpages}
...
\include{content/1_projektziele}
\include{content/2_projektverlauf}
\include{content/3_ergebnisse}
\include{content/4_qualitätssicherung}
\include{content/5_risikoanalyse}
\include{content/6_kommunikation}
\include{content/7_ressourcenmanagement}
\include{content/8_lessonslearned}
\include{content/9_abschlussbewertung}
